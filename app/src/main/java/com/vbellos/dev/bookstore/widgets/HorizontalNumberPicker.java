package com.vbellos.dev.bookstore.widgets;
...
public class HorizontalNumberPicker extends LinearLayout {
    ...
    private int min, max;
    ValueChangedEventListener mListener;
    ...
    public void setValueChangedEventListener(ValueChangedEventListener eventListener) {
